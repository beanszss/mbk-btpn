...
class Api_wow_master extends CI_Model
{
    public function index()
    {
       ...
       $primaryKey = 'id_wow';
       $columns = array(
           array('db' => '`mw`.`id_wow`', 'dt' => 'id_wow', 'field' => 'id_wow'),
           ...
           array('db' => '`mw`.`id_wow`', 'dt' => 'actions', 'field' => 'id_wow'),
        //    array('db' => 'id_device', 'dt' => 'id_device', 'field' => 'id_device'),
        //    array('db' => 'id_device', 'dt' => 'id_device', 'field' => 'id_device'),
       );
       $sql_details = $this->configDB();
       $joinQuery = "FROM `master_wow` AS `mw` 
