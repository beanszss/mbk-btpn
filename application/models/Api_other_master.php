...
class Api_other_master extends CI_Model
{
    public function index()
    {
       ...
       $primaryKey = 'id_other';
       $columns = array(
           array('db' => '`mw`.`id_other`', 'dt' => 'id_other', 'field' => 'id_other'),
           ...
           array('db' => '`mw`.`id_other`', 'dt' => 'actions', 'field' => 'id_other'),
        //    array('db' => 'id_device', 'dt' => 'id_device', 'field' => 'id_device'),
        //    array('db' => 'id_device', 'dt' => 'id_device', 'field' => 'id_device'),
       );
       $sql_details = $this->configDB();
       $joinQuery = "FROM `master_other` AS `mw` 
