...
class Api_sinaya_master extends CI_Model
{
    public function index()
    {
       $this->load->library('SSP');
       $table = 'master_sinaya';
       $primaryKey = 'id_sinaya';
       $columns = array(
           array('db' => '`mw`.`id_sinaya`', 'dt' => 'id_sinaya', 'field' => 'id_sinaya'),
           ...
           array('db' => '`mw`.`start_date`', 'dt' => 'start_date', 'field' => 'start_date',
            ...
            array('db' => '`mw`.`id_sinaya`', 'dt' => 'actions', 'field' => 'id_sinaya'),
        //    array('db' => 'id_device', 'dt' => 'id_device', 'field' => 'id_device'),
        //    array('db' => 'id_device', 'dt' => 'id_device', 'field' => 'id_device'),
       );
       $sql_details = $this->configDB();
       $joinQuery = "FROM `master_sinaya` AS `mw` 
