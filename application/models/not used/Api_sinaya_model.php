...
class Api_sinaya_model extends CI_Model
{
    /**
     * index
     * 
    ...
    public function index()
    {
        ...
        $columns = array(
            array('db' => 'id_sinaya', 'dt' => 'id_sinaya', 'field' => 'no'),
            array('db' => 'type', 'dt' => 'type', 'field' => 'type'),
            array('db' => 'imei', 'dt' => 'imei', 'field' => 'imei'),
            array('db' => 'sn', 'dt' => 'sn', 'field' => 'sn'),
            array('db' => 'tgl_delivery', 'dt' => 'tgl_delivery', 'field' => 'tgl_delivery',
            ...
            array('db' => 'no_po', 'dt' => 'no_po', 'field' => 'no_po'),
