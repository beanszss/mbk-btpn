...
class Sub_kanwil extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->load->model(array('api_sub_kanwil_model'));
	...
	{
		$id = $this->input->post('id_sub_kanwil');
		$data = $this->api_sub_kanwil_model->index($id);
